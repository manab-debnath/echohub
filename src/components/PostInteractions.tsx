...
const PostInteractions = ({
	...
	return (
		<div className="flex items-center justify-between mt-4 mb-2 gap-4 lg:gap-16 text-textGray">
			<div className="flex items-center justify-between flex-1">
				...
				<form action={rePostAction}>
					<button className="flex items-center gap-1 group hover:cursor-pointer">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="20"
							height="20"

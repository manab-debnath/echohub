			...
			<div className="w-full lg:w-1/2 flex flex-col gap-4">
				...
				<SignUp.Root>
					<SignUp.Step name="start" className="flex flex-col gap-2">
						<Clerk.Connection
							name="google"
							className="bg-white rounded-full p-2 w-72 text-black flex items-center justify-center gap-2 font-bold cursor-pointer"
						>
						...
						<div className="flex flex-col gap-2">
							<div className="w-72 flex text-textGray justify-center">
							...
							<SignUp.Action
								submit
								className="bg-iconBlue w-72 text-white mt-2 text-sm p-2 rounded-full text-center cursor-pointer"
							>
								Sign up
							</SignUp.Action>
						</div>
					...
					<SignUp.Step name="verifications">
						<SignUp.Strategy name="email_code">
							...
							<SignUp.Action
								submit
								className="bg-iconBlue w-72 text-white font-bold mt-2 text-sm p-2 rounded-full text-center cursor-pointer"
							>
								Verify
							</SignUp.Action>
						</SignUp.Strategy>
					...
					<p className="w-72 text-xs text-textGray">
